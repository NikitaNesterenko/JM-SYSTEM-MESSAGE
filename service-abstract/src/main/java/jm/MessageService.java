...
public interface MessageService {
    ...
    List<Message> getMessagesByBotIdByChannelIdForPeriod(@NonNull Long botId, @NonNull String channelName, @NonNull LocalDateTime startDate, @NonNull LocalDateTime endDate, @NonNull Boolean isDeleted);
