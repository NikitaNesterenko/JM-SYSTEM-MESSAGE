...
public class TestDataInitializer {
    ...
    public void createWorkspaceApps() {
//        List<User> userList = new ArrayList<>(this.users);
//        Map<String, String> slashMap = new HashMap<>();
//        slashMap.put("/help", "alt+f4");
//        WorkspaceApp workspaceApp_1 = new WorkspaceApp("alls", userList.get(0),workspace_1, slashMap);
//        workspaceAppDAO.persist(workspaceApp_1);
    }
