...
//     let voiceMessage = document.getElementById("inputMe");
//
//     console.log("!!!!!!!!!!!!!!!!!!" + voiceMessage);
//
//     if (input_element.value.length === 0 && voiceMessage.value === null &&
//         attach_file.value === null && (jQuery.trim(input_element.value)).length === 0)
//     {
//         e.preventDefault();
//         return;
//     }
...
//
//         input_element = document.getElementById("form_message_input");
//         const text_message = input_element.value;
//         input_element.value = null;
//         const currentDate = convert_date_to_format_Json(new Date());
//
//         let files;
//         files = document.getElementById("file_selector").files;
//         if (files === null) {
//             files = document.getElementById("vm_selector").files;
//         }
//         let filename;
//         if (files.length > 0) {
...
//     let fileupload;
//     fileupload = $("#vm_selector");
//     if (fileupload === null) {
//         fileupload = $("#file_selector");
//     }
//
